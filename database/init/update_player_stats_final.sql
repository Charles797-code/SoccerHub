...
BEGIN
    FOR club_rec IN (
        ...
        v_Mid_Goals := ROUND(v_Club_Goals * 0.25);
        v_Df_Goals := v_Club_Goals - v_Fw_Goals - v_Mid_Goals;
        ...
        FOR mid_rec IN (
            ...
            IF v_Players_Left > 1 THEN
                v_Player_Goals := ROUND((v_Mid_Goals - v_Assigned_Goals) / v_Players_Left);
