-- 使用PL/SQL精确分配球员进球数
DECLARE
    TYPE Goal_Array IS TABLE OF NUMBER INDEX BY VARCHAR2(10);
    v_Club_Goals NUMBER;
    v_Club_Id NUMBER;
        ...
        FOR fw_rec IN (
            ...
            IF v_Fw_Count > 0 THEN
                IF v_Fw_Goals > 0 THEN
                    v_Player_Goals := CEIL(v_Fw_Goals / v_Fw_Count);
        ...
        FOR mid_rec IN (
            ...
            IF v_Mid_Count > 0 THEN
                IF v_Mid_Goals > 0 THEN
                    v_Player_Goals := CEIL(v_Mid_Goals / v_Mid_Count);
        ...
        FOR df_rec IN (
            ...
            IF v_Df_Count > 0 THEN
                IF v_Df_Goals > 0 THEN
                    v_Player_Goals := CEIL(v_Df_Goals / v_Df_Count);
